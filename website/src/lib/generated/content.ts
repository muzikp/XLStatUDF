...
export const generatedAt = "2026-04-29T15:02:28.914Z";
export const docsByLanguage: Record<'cs' | 'en', GeneratedDoc[]> = {
  "cs": [
    ...
    },
    {
      ...
      "section": "Functions",
      "title": "Index Funkcí",
      "summary": "Index Funkcí Stav Office.js: funkce uvedené běžně jsou dostupné v aktivním Office.js doplňku. Stránky označené poznámkou ke stavu Office.js mohou obsahovat také archivovanou Excel",
      "sourcePath": "docs/cs/functions/index.md",
      "html": "<h1 id=\"index-funkci\">Index Funkcí</h1>\n<p>&gt; Stav Office.js: funkce uvedené běžně jsou dostupné v aktivním Office.js doplňku. Stránky označené poznámkou ke stavu Office.js mohou obsahovat také archivovanou Excel-DNA funkcionalitu, která se do Office.js teprve převádí.</p>\n<h2 id=\"obecne\">Obecné</h2>\n<ul><li><a href=\"/cs/docs/functions/diagnostics#version\">VERSION</a>: Vrací diagnostické informace o běžícím Office.js doplňku Evalytics.</li><li><a href=\"/cs/docs/functions/diagnostics#ping\">PING</a>: Vrací <code>1</code> jako minimální kontrolu latence custom functions.</li><li><a href=\"/cs/docs/functions/distributions#generatenorm\">GENERATE.NORM</a>: Generuje jednu náhodnou hodnotu z normálního rozdělení s volitelnou perturbací.</li><li><a href=\"/cs/docs/functions/distributions#generatenormarray\">GENERATE.NORM.ARRAY</a>: Generuje jednosloupcové pole náhodných hodnot z normálního rozdělení.</li><li><a href=\"/cs/docs/functions/distributions#generateint\">GENERATE.INT</a>: Generuje jedno náhodné celé číslo ze zadaného intervalu s volitelnou perturbací.</li><li><a href=\"/cs/docs/functions/distributions#generateintarray\">GENERATE.INT.ARRAY</a>: Generuje jednosloupcové pole náhodných celých čísel ze zadaného intervalu.</li><li><a href=\"/cs/docs/functions/distributions#fill\">FILL</a>: Opakuje jednu skalární hodnotu do jednosloupcového spill výstupu.</li><li><a href=\"/cs/docs/functions/distributions#fillrandom\">FILL.RANDOM</a>: Sestavuje řadu jako <code>FILL</code> a následně ji náhodně promíchá.</li></ul>\n<h2 id=\"popisne\">Popisné</h2>\n<ul><li><a href=\"/cs/docs/functions/weighted-means#averagew\">AVERAGE.W</a>: Počítá vážený aritmetický průměr.</li><li><a href=\"/cs/docs/functions/weighted-means#harmeanw\">HARMEAN.W</a>: Počítá vážený harmonický průměr.</li><li><a href=\"/cs/docs/functions/weighted-means#geomeanw\">GEOMEAN.W</a>: Počítá vážený geometrický průměr.</li><li><a href=\"/cs/docs/functions/weighted-variance#varpw\">VAR.P.W</a>: Počítá vážený populační rozptyl.</li><li><a href=\"/cs/docs/functions/weighted-variance#varsw\">VAR.S.W</a>: Počítá vážený výběrový rozptyl.</li><li><a href=\"/cs/docs/functions/weighted-variance#stdevpw\">STDEV.P.W</a>: Počítá váženou populační směrodatnou odchylku.</li><li><a href=\"/cs/docs/functions/weighted-variance#stdevsw\">STDEV.S.W</a>: Počítá váženou výběrovou směrodatnou odchylku.</li><li><a href=\"/cs/docs/functions/variation-coefficients#varcoef\">VARCOEF</a>: Počítá populační variační koeficient.</li><li><a href=\"/cs/docs/functions/variation-coefficients#varcoefs\">VARCOEF.S</a>: Počítá výběrový variační koeficient.</li><li><a href=\"/cs/docs/functions/variation-coefficients#varcoefw\">VARCOEF.W</a>: Počítá vážený populační variační koeficient.</li><li><a href=\"/cs/docs/functions/variation-coefficients#varcoefsw\">VARCOEF.S.W</a>: Počítá vážený výběrový variační koeficient.</li><li><a href=\"/cs/docs/functions/percentiles#percentileincifs\">PERCENTILE.INC.IFS</a>: Počítá inkluzivní percentil po aplikaci filtrů.</li><li><a href=\"/cs/docs/functions/percentiles#percentileexcifs\">PERCENTILE.EXC.IFS</a>: Počítá exkluzivní percentil po aplikaci filtrů.</li><li><a href=\"/cs/docs/functions/pivot#pivotcount\">PIVOT.COUNT</a>: Sestavuje pivot a počítá neprázdné hodnoty.</li><li><a href=\"/cs/docs/functions/pivot#pivotsum\">PIVOT.SUM</a>: Sestavuje pivot a počítá součty.</li><li><a href=\"/cs/docs/functions/pivot#pivotaverage\">PIVOT.AVERAGE</a>: Sestavuje pivot a počítá aritmetické průměry.</li><li><a href=\"/cs/docs/functions/pivot#pivotmin\">PIVOT.MIN</a>: Sestavuje pivot a počítá minima.</li><li><a href=\"/cs/docs/functions/pivot#pivotmax\">PIVOT.MAX</a>: Sestavuje pivot a počítá maxima.</li><li><a href=\"/cs/docs/functions/pivot#pivotmedian\">PIVOT.MEDIAN</a>: Sestavuje pivot a počítá mediány.</li><li><a href=\"/cs/docs/functions/pivot#pivotpercentile\">PIVOT.PERCENTILE</a>: Sestavuje pivot a počítá percentily.</li><li><a href=\"/cs/docs/functions/pivot#pivotstdevs\">PIVOT.STDEV.S</a>: Sestavuje pivot a počítá výběrové směrodatné odchylky.</li><li><a href=\"/cs/docs/functions/pivot#pivotstdevp\">PIVOT.STDEV.P</a>: Sestavuje pivot a počítá populační směrodatné odchylky.</li><li><a href=\"/cs/docs/functions/pivot#pivotvars\">PIVOT.VAR.S</a>: Sestavuje pivot a počítá výběrové rozptyly.</li><li><a href=\"/cs/docs/functions/pivot#pivotvarp\">PIVOT.VAR.P</a>: Sestavuje pivot a počítá populační rozptyly.</li><li><a href=\"/cs/docs/functions/pivot#pivotvarcoefs\">PIVOT.VARCOEF.S</a>: Sestavuje pivot a počítá výběrové variační koeficienty.</li><li><a href=\"/cs/docs/functions/pivot#pivotvarcoefp\">PIVOT.VARCOEF.P</a>: Sestavuje pivot a počítá populační variační koeficienty.</li><li><a href=\"/cs/docs/functions/pivot#pivotconft\">PIVOT.CONF.T</a>: Sestavuje pivot a počítá poloviční šířky t-intervalů spolehlivosti.</li><li><a href=\"/cs/docs/functions/pivot#pivotconfnorm\">PIVOT.CONF.NORM</a>: Sestavuje pivot a počítá poloviční šířky intervalů spolehlivosti přes normální aproximaci.</li><li><a href=\"/cs/docs/functions/pivot#pivotmad\">PIVOT.MAD</a>: Sestavuje pivot a počítá medián absolutních odchylek.</li><li><a href=\"/cs/docs/functions/pivot#pivotiqr\">PIVOT.IQR</a>: Sestavuje pivot a počítá mezikvartilová rozpětí.</li></ul>\n<h2 id=\"testy\">Testy</h2>\n<ul><li><a href=\"/cs/docs/functions/distributions#normdistrange\">NORM.DIST.RANGE</a>: Počítá pravděpodobnost intervalu normálního rozdělení.</li><li><a href=\"/cs/docs/functions/normality#shapirowilk\">SHAPIRO.WILK</a>: Provádí Shapiro-Wilkův test normality.</li><li><a href=\"/cs/docs/functions/normality#kolmogorovsmirnov\">KOLMOGOROV.SMIRNOV</a>: Provádí Kolmogorov-Smirnovův test dobré shody pro zvolené rozdělení.</li><li><a href=\"/cs/docs/functions/one-sample-tests#ttest1s\">T.TEST.1S</a>: Provádí jednovýběrový t-test vůči zadané hypotetické střední hodnotě.</li><li><a href=\"/cs/docs/functions/one-sample-tests#proptest1s\">PROP.TEST.1S</a>: Provádí jednovýběrový test podílu.</li><li><a href=\"/cs/docs/functions/one-sample-tests#wilcoxonpaired\">WILCOXON.PAIRED</a>: Provádí Wilcoxonův párový znaménkový test pro závislá měření.</li><li><a href=\"/cs/docs/functions/two-sample-tests#welchtest2sg\">WELCH.TEST.2S.G</a>: Provádí Welchův dvouvýběrový t-test pro dvě nezávislé skupiny.</li><li><a href=\"/cs/docs/functions/two-sample-tests#mannwhitneyg\">MANN.WHITNEY.G</a>: Provádí Mann-Whitneyho test pro dvě nezávislé skupiny.</li><li><a href=\"/cs/docs/functions/goodness-of-fit#chisqgof\">CHISQ.GOF</a>: Provádí chí-kvadrát test dobré shody.</li><li><a href=\"/cs/docs/functions/anova#anovag\">ANOVA.G</a>: Provádí jednofaktorovou ANOVA nad groupovanými daty.</li><li><a href=\"/cs/docs/functions/anova#anovarm\">ANOVA.RM</a>: Provádí ANOVA s opakovaným měřením nad sloupci.</li><li><a href=\"/cs/docs/functions/ancova#ancovag\">ANCOVA.G</a>: Provádí ANCOVA s jedním faktorem a jednou nebo více kovariátami.</li><li><a href=\"/cs/docs/functions/contingency#contingencyt\">CONTINGENCY.T</a>: Analyzuje kontingenční tabulku zadanou přímo jako matici četností.</li><li><a href=\"/cs/docs/functions/contingency#contingencyg\">CONTINGENCY.G</a>: Analyzuje kontingenční tabulku sestavenou z groupovaných sloupců.</li><li><a href=\"/cs/docs/functions/correlation#correlspearman\">CORREL.SPEARMAN</a>: Počítá Spearmanův korelační koeficient a test jeho významnosti.</li><li><a href=\"/cs/docs/functions/correlation#correlmatrix\">CORREL.MATRIX</a>: Sestavuje korelační matici včetně p-hodnot a značek signifikance.</li></ul>"
    },
    {
      "lang": "cs",
    ...
    },
    {
      ...
      "slug": "overview",
      "section": "Overview",
      "title": "Dokumentace Evalytics",
      "summary": "Dokumentace Evalytics Tato větev obsahuje uživatelskou dokumentaci doplňku Evalytics v češtině. Hlavní build Aktivní implementace je Office.js doplněk v adresáři office addin/. Pův",
      "sourcePath": "docs/cs/README.md",
      "html": "<h1 id=\"dokumentace-evalytics\">Dokumentace Evalytics</h1>\n<p>Tato větev obsahuje uživatelskou dokumentaci doplňku Evalytics v češtině.</p>\n<h2 id=\"hlavni-build\">Hlavní build</h2>\n<p>Aktivní implementace je Office.js doplněk v adresáři <code>office-addin/</code>. Původní Excel-DNA <code>.xll</code> build je archivovaný jen pro kontrolu parity.</p>\n<h2 id=\"obsah\">Obsah</h2>\n<ul><li><a href=\"/cs/docs/framework\">Přehled frameworku</a></li><li><a href=\"/cs/docs/functions/index\">Index funkcí</a></li></ul>\n<h2 id=\"referencni-podklady\">Referenční podklady</h2>\n<p>Původní zadávací dokumenty jsou uložené zde:</p>\n<ul><li><code>reference/project-spec/xlstatudf_copilot_prompt.md</code></li><li><code>reference/project-spec/xlstatudf_udf_dokumentace.md</code></li></ul>"
    }
  ],
  "en": [
    {
      ...
      "summary": "Framework Overview Purpose Evalytics is an Excel add in that provides statistical user defined functions for teaching and applied statistical work in spreadsheets. The active imple",
      "sourcePath": "docs/en/framework.md",
      "html": "<h1 id=\"framework-overview\">Framework Overview</h1>\n<h2 id=\"purpose\">Purpose</h2>\n<p>Evalytics is an Excel add-in that provides statistical user-defined functions for teaching and applied statistical work in spreadsheets.</p>\n<p>The active implementation is being migrated to Office.js custom functions so it can run across Excel on Windows, Mac, and the web. The original Excel-DNA implementation remains in the repository as an archived reference for parity checks.</p>\n<h2 id=\"runtime\">Runtime</h2>\n<ul><li>active Excel integration: <code>Office.js</code> custom functions</li><li>active implementation language: TypeScript</li><li>active runtime bundle: <code>office-addin/dist/functions.js</code></li><li>archived runtime: <code>.NET 8</code> + <code>Excel-DNA</code></li><li>archived numeric/statistical library: <code>MathNet.Numerics</code></li></ul>\n<h2 id=\"main-build-path\">Main Build Path</h2>\n<p>The active Office.js build is produced from:</p>\n<ul><li><code>office-addin/</code></li></ul>\n<pre><code class=\"language-powershell\">Set-Location .\\office-addin\nnpm run build</code></pre>\n<p>The archived Excel-DNA build is no longer the primary product path.</p>\n<h2 id=\"header-mode\">Header Mode</h2>\n<p>Relevant functions support an optional final header argument:</p>\n<table><thead><tr><th>Code</th><th>Meaning</th></tr></thead><tbody><tr><td><code>0</code></td><td>auto-detect header</td></tr><tr><td><code>1</code></td><td>header is present</td></tr><tr><td><code>2</code></td><td>header is not present</td></tr></tbody></table>"
    },
    {
      "lang": "en",
      "slug": "functions/ancova",
    ...
    },
    {
      ...
      "section": "Functions",
      "title": "Diagnostics",
      "summary": "Diagnostics VERSION Returns a short diagnostic string describing the loaded Evalytics add in runtime. Syntax Output The scalar text output includes the add in brand, implementation",
      "sourcePath": "docs/en/functions/diagnostics.md",
      "html": "<h1 id=\"diagnostics\">Diagnostics</h1>\n<h2 id=\"version\"><code>VERSION</code></h2>\n<p>Returns a short diagnostic string describing the loaded Evalytics add-in runtime.</p>\n<h3 id=\"syntax\">Syntax</h3>\n<pre><code class=\"language-excel\">=VERSION()</code></pre>\n<h3 id=\"output\">Output</h3>\n<p>The scalar text output includes the add-in brand, implementation runtime, and internal version, for example:</p>\n<pre><code class=\"language-text\">Evalytics Office.js 1.0.0</code></pre>\n<h3 id=\"notes\">Notes</h3>\n<ul><li>use this function to verify that Excel loaded the Office.js add-in rather than the archived Excel-DNA build</li><li>in Excel the function is called with the configured namespace as <code>=EVALYTICS.VERSION()</code></li></ul>\n<h2 id=\"ping\"><code>PING</code></h2>\n<p>Returns <code>1</code> as a minimal latency and availability probe.</p>\n<h3 id=\"syntax\">Syntax</h3>\n<pre><code class=\"language-excel\">=PING()</code></pre>\n<h3 id=\"output\">Output</h3>\n<p>The function returns the number <code>1</code>.</p>\n<h3 id=\"notes\">Notes</h3>\n<ul><li>use this function when checking whether custom functions are loaded and responding</li><li>in Excel the function is called with the configured namespace as <code>=EVALYTICS.PING()</code></li></ul>"
    },
    {
      "lang": "en",
      "slug": "functions/distributions",
    ...
    },
    {
      ...
      "summary": "Functions Index Office.js status: functions listed in regular text are available in the active Office.js add in. Pages marked with an Office.js status note may also document archiv",
      "sourcePath": "docs/en/functions/index.md",
      "html": "<h1 id=\"functions-index\">Functions Index</h1>\n<p>&gt; Office.js status: functions listed in regular text are available in the active Office.js add-in. Pages marked with an Office.js status note may also document archived Excel-DNA functionality that is still pending in Office.js.</p>\n<h2 id=\"general\">General</h2>\n<ul><li><a href=\"/en/docs/functions/diagnostics#version\">VERSION</a>: Returns diagnostic information about the running Evalytics Office.js add-in.</li><li><a href=\"/en/docs/functions/diagnostics#ping\">PING</a>: Returns <code>1</code> as a minimal custom-function latency probe.</li><li><a href=\"/en/docs/functions/distributions#generatenorm\">GENERATE.NORM</a>: Generates a single random value from a normal distribution with optional perturbation.</li><li><a href=\"/en/docs/functions/distributions#generatenormarray\">GENERATE.NORM.ARRAY</a>: Generates a single-column array of random values from a normal distribution.</li><li><a href=\"/en/docs/functions/distributions#generateint\">GENERATE.INT</a>: Generates a single random integer from a specified interval with optional perturbation.</li><li><a href=\"/en/docs/functions/distributions#generateintarray\">GENERATE.INT.ARRAY</a>: Generates a single-column array of random integers from a specified interval.</li><li><a href=\"/en/docs/functions/distributions#fill\">FILL</a>: Repeats one scalar value into a single-column spill output.</li><li><a href=\"/en/docs/functions/distributions#fillrandom\">FILL.RANDOM</a>: Builds a sequence like <code>FILL</code> and then shuffles it randomly.</li></ul>\n<h2 id=\"descriptive\">Descriptive</h2>\n<ul><li><a href=\"/en/docs/functions/weighted-means#averagew\">AVERAGE.W</a>: Computes the weighted arithmetic mean.</li><li><a href=\"/en/docs/functions/weighted-means#harmeanw\">HARMEAN.W</a>: Computes the weighted harmonic mean.</li><li><a href=\"/en/docs/functions/weighted-means#geomeanw\">GEOMEAN.W</a>: Computes the weighted geometric mean.</li><li><a href=\"/en/docs/functions/weighted-variance#varpw\">VAR.P.W</a>: Computes the weighted population variance.</li><li><a href=\"/en/docs/functions/weighted-variance#varsw\">VAR.S.W</a>: Computes the weighted sample variance.</li><li><a href=\"/en/docs/functions/weighted-variance#stdevpw\">STDEV.P.W</a>: Computes the weighted population standard deviation.</li><li><a href=\"/en/docs/functions/weighted-variance#stdevsw\">STDEV.S.W</a>: Computes the weighted sample standard deviation.</li><li><a href=\"/en/docs/functions/variation-coefficients#varcoef\">VARCOEF</a>: Computes the population coefficient of variation.</li><li><a href=\"/en/docs/functions/variation-coefficients#varcoefs\">VARCOEF.S</a>: Computes the sample coefficient of variation.</li><li><a href=\"/en/docs/functions/variation-coefficients#varcoefw\">VARCOEF.W</a>: Computes the weighted population coefficient of variation.</li><li><a href=\"/en/docs/functions/variation-coefficients#varcoefsw\">VARCOEF.S.W</a>: Computes the weighted sample coefficient of variation.</li><li><a href=\"/en/docs/functions/percentiles#percentileincifs\">PERCENTILE.INC.IFS</a>: Computes the inclusive percentile after applying filters.</li><li><a href=\"/en/docs/functions/percentiles#percentileexcifs\">PERCENTILE.EXC.IFS</a>: Computes the exclusive percentile after applying filters.</li><li><a href=\"/en/docs/functions/pivot#pivotcount\">PIVOT.COUNT</a>: Builds a pivot and counts non-empty values.</li><li><a href=\"/en/docs/functions/pivot#pivotsum\">PIVOT.SUM</a>: Builds a pivot and computes sums.</li><li><a href=\"/en/docs/functions/pivot#pivotaverage\">PIVOT.AVERAGE</a>: Builds a pivot and computes arithmetic means.</li><li><a href=\"/en/docs/functions/pivot#pivotmin\">PIVOT.MIN</a>: Builds a pivot and computes minimums.</li><li><a href=\"/en/docs/functions/pivot#pivotmax\">PIVOT.MAX</a>: Builds a pivot and computes maximums.</li><li><a href=\"/en/docs/functions/pivot#pivotmedian\">PIVOT.MEDIAN</a>: Builds a pivot and computes medians.</li><li><a href=\"/en/docs/functions/pivot#pivotpercentile\">PIVOT.PERCENTILE</a>: Builds a pivot and computes percentiles.</li><li><a href=\"/en/docs/functions/pivot#pivotstdevs\">PIVOT.STDEV.S</a>: Builds a pivot and computes sample standard deviations.</li><li><a href=\"/en/docs/functions/pivot#pivotstdevp\">PIVOT.STDEV.P</a>: Builds a pivot and computes population standard deviations.</li><li><a href=\"/en/docs/functions/pivot#pivotvars\">PIVOT.VAR.S</a>: Builds a pivot and computes sample variances.</li><li><a href=\"/en/docs/functions/pivot#pivotvarp\">PIVOT.VAR.P</a>: Builds a pivot and computes population variances.</li><li><a href=\"/en/docs/functions/pivot#pivotvarcoefs\">PIVOT.VARCOEF.S</a>: Builds a pivot and computes sample coefficients of variation.</li><li><a href=\"/en/docs/functions/pivot#pivotvarcoefp\">PIVOT.VARCOEF.P</a>: Builds a pivot and computes population coefficients of variation.</li><li><a href=\"/en/docs/functions/pivot#pivotconft\">PIVOT.CONF.T</a>: Builds a pivot and computes t-based confidence interval half-widths.</li><li><a href=\"/en/docs/functions/pivot#pivotconfnorm\">PIVOT.CONF.NORM</a>: Builds a pivot and computes normal-approximation confidence interval half-widths.</li><li><a href=\"/en/docs/functions/pivot#pivotmad\">PIVOT.MAD</a>: Builds a pivot and computes median absolute deviations.</li><li><a href=\"/en/docs/functions/pivot#pivotiqr\">PIVOT.IQR</a>: Builds a pivot and computes interquartile ranges.</li></ul>\n<h2 id=\"tests\">Tests</h2>\n<ul><li><a href=\"/en/docs/functions/distributions#normdistrange\">NORM.DIST.RANGE</a>: Computes the probability of an interval under the normal distribution.</li><li><a href=\"/en/docs/functions/normality#shapirowilk\">SHAPIRO.WILK</a>: Performs the Shapiro-Wilk normality test.</li><li><a href=\"/en/docs/functions/normality#kolmogorovsmirnov\">KOLMOGOROV.SMIRNOV</a>: Performs the Kolmogorov-Smirnov goodness-of-fit test for the selected distribution.</li><li><a href=\"/en/docs/functions/one-sample-tests#ttest1s\">T.TEST.1S</a>: Performs a one-sample t-test against a specified hypothetical mean.</li><li><a href=\"/en/docs/functions/one-sample-tests#proptest1s\">PROP.TEST.1S</a>: Performs a one-sample proportion test.</li><li><a href=\"/en/docs/functions/one-sample-tests#wilcoxonpaired\">WILCOXON.PAIRED</a>: Performs the Wilcoxon signed-rank test for dependent measurements.</li><li><a href=\"/en/docs/functions/two-sample-tests#welchtest2sg\">WELCH.TEST.2S.G</a>: Performs Welch&#39;s two-sample t-test for two independent groups.</li><li><a href=\"/en/docs/functions/two-sample-tests#mannwhitneyg\">MANN.WHITNEY.G</a>: Performs the Mann-Whitney test for two independent groups.</li><li><a href=\"/en/docs/functions/goodness-of-fit#chisqgof\">CHISQ.GOF</a>: Performs the chi-square goodness-of-fit test.</li><li><a href=\"/en/docs/functions/anova#anovag\">ANOVA.G</a>: Performs one-way ANOVA on grouped data.</li><li><a href=\"/en/docs/functions/anova#anovarm\">ANOVA.RM</a>: Performs repeated-measures ANOVA across columns.</li><li><a href=\"/en/docs/functions/ancova#ancovag\">ANCOVA.G</a>: Performs ANCOVA with one factor and one or more covariates.</li><li><a href=\"/en/docs/functions/contingency#contingencyt\">CONTINGENCY.T</a>: Analyzes a contingency table entered directly as a frequency matrix.</li><li><a href=\"/en/docs/functions/contingency#contingencyg\">CONTINGENCY.G</a>: Analyzes a contingency table built from grouped columns.</li><li><a href=\"/en/docs/functions/correlation#correlspearman\">CORREL.SPEARMAN</a>: Computes Spearman correlation and its significance test.</li><li><a href=\"/en/docs/functions/correlation#correlmatrix\">CORREL.MATRIX</a>: Builds a correlation matrix including p-values and significance markers.</li></ul>"
    },
    {
      "lang": "en",
      "slug": "functions/normality",
    ...
    },
    {
      ...
      "slug": "overview",
      "section": "Overview",
      "title": "Evalytics Documentation",
      "summary": "Evalytics Documentation This branch contains the English user facing documentation for Evalytics. Main Build The active implementation is the Office.js add in in office addin/. The",
      "sourcePath": "docs/en/README.md",
      "html": "<h1 id=\"evalytics-documentation\">Evalytics Documentation</h1>\n<p>This branch contains the English user-facing documentation for Evalytics.</p>\n<h2 id=\"main-build\">Main Build</h2>\n<p>The active implementation is the Office.js add-in in <code>office-addin/</code>. The original Excel-DNA <code>.xll</code> build is archived only for parity checks.</p>\n<h2 id=\"contents\">Contents</h2>\n<ul><li><a href=\"/en/docs/framework\">Framework Overview</a></li><li><a href=\"/en/docs/functions/index\">Functions Index</a></li></ul>"
    }
  ]
};
  ...
  "cs": [
    {
      "lang": "cs",
      "name": "VERSION",
      "summary": "Vrací diagnostické informace o běžícím Office.js doplňku Evalytics.",
      "href": "/cs/docs/functions/diagnostics#version"
    },
    {
      "lang": "cs",
      "name": "PING",
      "summary": "Vrací `1` jako minimální kontrolu latence custom functions.",
      "href": "/cs/docs/functions/diagnostics#ping"
    },
    {
      "lang": "cs",
      "name": "GENERATE.NORM",
      "summary": "Generuje jednu náhodnou hodnotu z normálního rozdělení s volitelnou perturbací.",
      "href": "/cs/docs/functions/distributions#generatenorm"
    },
    {
      "lang": "cs",
      "name": "GENERATE.NORM.ARRAY",
      "summary": "Generuje jednosloupcové pole náhodných hodnot z normálního rozdělení.",
      "href": "/cs/docs/functions/distributions#generatenormarray"
    },
    {
      "lang": "cs",
      "name": "GENERATE.INT",
      "summary": "Generuje jedno náhodné celé číslo ze zadaného intervalu s volitelnou perturbací.",
      "href": "/cs/docs/functions/distributions#generateint"
    },
    {
      "lang": "cs",
      "name": "GENERATE.INT.ARRAY",
      "summary": "Generuje jednosloupcové pole náhodných celých čísel ze zadaného intervalu.",
      "href": "/cs/docs/functions/distributions#generateintarray"
    },
    {
      "lang": "cs",
      "name": "FILL",
      "summary": "Opakuje jednu skalární hodnotu do jednosloupcového spill výstupu.",
      "href": "/cs/docs/functions/distributions#fill"
    },
    {
      "lang": "cs",
      "name": "FILL.RANDOM",
      "summary": "Sestavuje řadu jako `FILL` a následně ji náhodně promíchá.",
      "href": "/cs/docs/functions/distributions#fillrandom"
    },
    {
      "lang": "cs",
      "name": "AVERAGE.W",
      "summary": "Počítá vážený aritmetický průměr.",
      "href": "/cs/docs/functions/weighted-means#averagew"
    },
    {
      "lang": "cs",
      "name": "HARMEAN.W",
      "summary": "Počítá vážený harmonický průměr.",
      "href": "/cs/docs/functions/weighted-means#harmeanw"
    },
    {
      "lang": "cs",
      "name": "GEOMEAN.W",
      "summary": "Počítá vážený geometrický průměr.",
      "href": "/cs/docs/functions/weighted-means#geomeanw"
    },
    {
      "lang": "cs",
      "name": "VAR.P.W",
      "summary": "Počítá vážený populační rozptyl.",
      "href": "/cs/docs/functions/weighted-variance#varpw"
    },
    {
      "lang": "cs",
      "name": "VAR.S.W",
      "summary": "Počítá vážený výběrový rozptyl.",
      "href": "/cs/docs/functions/weighted-variance#varsw"
    },
    {
      "lang": "cs",
      "name": "STDEV.P.W",
      "summary": "Počítá váženou populační směrodatnou odchylku.",
      "href": "/cs/docs/functions/weighted-variance#stdevpw"
    },
    {
      "lang": "cs",
      "name": "STDEV.S.W",
      "summary": "Počítá váženou výběrovou směrodatnou odchylku.",
      "href": "/cs/docs/functions/weighted-variance#stdevsw"
    },
    {
      "lang": "cs",
      "name": "VARCOEF",
      "summary": "Počítá populační variační koeficient.",
      "href": "/cs/docs/functions/variation-coefficients#varcoef"
    },
    {
      "lang": "cs",
      "name": "VARCOEF.S",
      "summary": "Počítá výběrový variační koeficient.",
      "href": "/cs/docs/functions/variation-coefficients#varcoefs"
    },
    {
      "lang": "cs",
      "name": "VARCOEF.W",
      "summary": "Počítá vážený populační variační koeficient.",
      "href": "/cs/docs/functions/variation-coefficients#varcoefw"
    },
    {
      "lang": "cs",
      "name": "VARCOEF.S.W",
      "summary": "Počítá vážený výběrový variační koeficient.",
      "href": "/cs/docs/functions/variation-coefficients#varcoefsw"
    },
    {
      "lang": "cs",
      "name": "PERCENTILE.INC.IFS",
      "summary": "Počítá inkluzivní percentil po aplikaci filtrů.",
      "href": "/cs/docs/functions/percentiles#percentileincifs"
    },
    {
      "lang": "cs",
      "name": "PERCENTILE.EXC.IFS",
      "summary": "Počítá exkluzivní percentil po aplikaci filtrů.",
      "href": "/cs/docs/functions/percentiles#percentileexcifs"
    },
    {
      "lang": "cs",
      "name": "PIVOT.COUNT",
      "summary": "Sestavuje pivot a počítá neprázdné hodnoty.",
      "href": "/cs/docs/functions/pivot#pivotcount"
    },
    {
      "lang": "cs",
      "name": "PIVOT.SUM",
      "summary": "Sestavuje pivot a počítá součty.",
      "href": "/cs/docs/functions/pivot#pivotsum"
    },
    {
      "lang": "cs",
      "name": "PIVOT.AVERAGE",
      "summary": "Sestavuje pivot a počítá aritmetické průměry.",
      "href": "/cs/docs/functions/pivot#pivotaverage"
    },
    {
      "lang": "cs",
      "name": "PIVOT.MIN",
      "summary": "Sestavuje pivot a počítá minima.",
      "href": "/cs/docs/functions/pivot#pivotmin"
    },
    {
      "lang": "cs",
      "name": "PIVOT.MAX",
      "summary": "Sestavuje pivot a počítá maxima.",
      "href": "/cs/docs/functions/pivot#pivotmax"
    },
    {
      "lang": "cs",
      "name": "PIVOT.MEDIAN",
      "summary": "Sestavuje pivot a počítá mediány.",
      "href": "/cs/docs/functions/pivot#pivotmedian"
    },
    {
      "lang": "cs",
      "name": "PIVOT.PERCENTILE",
      "summary": "Sestavuje pivot a počítá percentily.",
      "href": "/cs/docs/functions/pivot#pivotpercentile"
    },
    {
      "lang": "cs",
      "name": "PIVOT.STDEV.S",
      "summary": "Sestavuje pivot a počítá výběrové směrodatné odchylky.",
      "href": "/cs/docs/functions/pivot#pivotstdevs"
    },
    {
      "lang": "cs",
      "name": "PIVOT.STDEV.P",
      "summary": "Sestavuje pivot a počítá populační směrodatné odchylky.",
      "href": "/cs/docs/functions/pivot#pivotstdevp"
    },
    {
      "lang": "cs",
      "name": "PIVOT.VAR.S",
      "summary": "Sestavuje pivot a počítá výběrové rozptyly.",
      "href": "/cs/docs/functions/pivot#pivotvars"
    },
    {
      "lang": "cs",
      "name": "PIVOT.VAR.P",
      "summary": "Sestavuje pivot a počítá populační rozptyly.",
      "href": "/cs/docs/functions/pivot#pivotvarp"
    },
    {
      "lang": "cs",
      "name": "PIVOT.VARCOEF.S",
      "summary": "Sestavuje pivot a počítá výběrové variační koeficienty.",
      "href": "/cs/docs/functions/pivot#pivotvarcoefs"
    },
    {
      "lang": "cs",
      "name": "PIVOT.VARCOEF.P",
      "summary": "Sestavuje pivot a počítá populační variační koeficienty.",
      "href": "/cs/docs/functions/pivot#pivotvarcoefp"
    },
    {
      "lang": "cs",
      "name": "PIVOT.CONF.T",
      "summary": "Sestavuje pivot a počítá poloviční šířky t-intervalů spolehlivosti.",
      "href": "/cs/docs/functions/pivot#pivotconft"
    },
    {
      "lang": "cs",
      "name": "PIVOT.CONF.NORM",
      "summary": "Sestavuje pivot a počítá poloviční šířky intervalů spolehlivosti přes normální aproximaci.",
      "href": "/cs/docs/functions/pivot#pivotconfnorm"
    },
    {
      "lang": "cs",
      "name": "PIVOT.MAD",
      "summary": "Sestavuje pivot a počítá medián absolutních odchylek.",
      "href": "/cs/docs/functions/pivot#pivotmad"
    },
    {
      "lang": "cs",
      "name": "PIVOT.IQR",
      "summary": "Sestavuje pivot a počítá mezikvartilová rozpětí.",
      "href": "/cs/docs/functions/pivot#pivotiqr"
    },
    {
      "lang": "cs",
      "name": "NORM.DIST.RANGE",
      "summary": "Počítá pravděpodobnost intervalu normálního rozdělení.",
      "href": "/cs/docs/functions/distributions#normdistrange"
    },
    {
      "lang": "cs",
      "name": "SHAPIRO.WILK",
      "summary": "Provádí Shapiro-Wilkův test normality.",
      "href": "/cs/docs/functions/normality#shapirowilk"
    },
    {
      "lang": "cs",
      "name": "KOLMOGOROV.SMIRNOV",
      "summary": "Provádí Kolmogorov-Smirnovův test dobré shody pro zvolené rozdělení.",
      "href": "/cs/docs/functions/normality#kolmogorovsmirnov"
    },
    {
      "lang": "cs",
      "name": "T.TEST.1S",
      "summary": "Provádí jednovýběrový t-test vůči zadané hypotetické střední hodnotě.",
      "href": "/cs/docs/functions/one-sample-tests#ttest1s"
    },
    {
      "lang": "cs",
      "name": "PROP.TEST.1S",
      "summary": "Provádí jednovýběrový test podílu.",
      "href": "/cs/docs/functions/one-sample-tests#proptest1s"
    },
    {
      "lang": "cs",
      "name": "WILCOXON.PAIRED",
      "summary": "Provádí Wilcoxonův párový znaménkový test pro závislá měření.",
      "href": "/cs/docs/functions/one-sample-tests#wilcoxonpaired"
    },
    {
      "lang": "cs",
      "name": "WELCH.TEST.2S.G",
      "summary": "Provádí Welchův dvouvýběrový t-test pro dvě nezávislé skupiny.",
      "href": "/cs/docs/functions/two-sample-tests#welchtest2sg"
    },
    {
      "lang": "cs",
      "name": "MANN.WHITNEY.G",
      "summary": "Provádí Mann-Whitneyho test pro dvě nezávislé skupiny.",
      "href": "/cs/docs/functions/two-sample-tests#mannwhitneyg"
    },
    {
      "lang": "cs",
      "name": "CHISQ.GOF",
      "summary": "Provádí chí-kvadrát test dobré shody.",
      "href": "/cs/docs/functions/goodness-of-fit#chisqgof"
    },
    {
      "lang": "cs",
      "name": "ANOVA.G",
      "summary": "Provádí jednofaktorovou ANOVA nad groupovanými daty.",
      "href": "/cs/docs/functions/anova#anovag"
    },
    {
      "lang": "cs",
      "name": "ANOVA.RM",
      "summary": "Provádí ANOVA s opakovaným měřením nad sloupci.",
      "href": "/cs/docs/functions/anova#anovarm"
    },
    {
      "lang": "cs",
      "name": "ANCOVA.G",
      "summary": "Provádí ANCOVA s jedním faktorem a jednou nebo více kovariátami.",
      "href": "/cs/docs/functions/ancova#ancovag"
    },
    {
      "lang": "cs",
      "name": "CONTINGENCY.T",
      "summary": "Analyzuje kontingenční tabulku zadanou přímo jako matici četností.",
      "href": "/cs/docs/functions/contingency#contingencyt"
    },
    {
      "lang": "cs",
      "name": "CONTINGENCY.G",
      "summary": "Analyzuje kontingenční tabulku sestavenou z groupovaných sloupců.",
      "href": "/cs/docs/functions/contingency#contingencyg"
    },
    {
      "lang": "cs",
      "name": "CORREL.SPEARMAN",
      "summary": "Počítá Spearmanův korelační koeficient a test jeho významnosti.",
      "href": "/cs/docs/functions/correlation#correlspearman"
    },
    {
      "lang": "cs",
      "name": "CORREL.MATRIX",
      "summary": "Sestavuje korelační matici včetně p-hodnot a značek signifikance.",
      "href": "/cs/docs/functions/correlation#correlmatrix"
    }
  ],
  "en": [
    {
      "lang": "en",
      "name": "VERSION",
      "summary": "Returns diagnostic information about the running Evalytics Office.js add-in.",
      "href": "/en/docs/functions/diagnostics#version"
    },
    {
      "lang": "en",
      "name": "PING",
      "summary": "Returns `1` as a minimal custom-function latency probe.",
      "href": "/en/docs/functions/diagnostics#ping"
    },
    {
      "lang": "en",
      "name": "GENERATE.NORM",
      "summary": "Generates a single random value from a normal distribution with optional perturbation.",
      "href": "/en/docs/functions/distributions#generatenorm"
    },
    {
      "lang": "en",
      "name": "GENERATE.NORM.ARRAY",
      "summary": "Generates a single-column array of random values from a normal distribution.",
      "href": "/en/docs/functions/distributions#generatenormarray"
    },
    {
      "lang": "en",
      "name": "GENERATE.INT",
      "summary": "Generates a single random integer from a specified interval with optional perturbation.",
      "href": "/en/docs/functions/distributions#generateint"
    },
    {
      "lang": "en",
      "name": "GENERATE.INT.ARRAY",
      "summary": "Generates a single-column array of random integers from a specified interval.",
      "href": "/en/docs/functions/distributions#generateintarray"
    },
    {
      "lang": "en",
      "name": "FILL",
      "summary": "Repeats one scalar value into a single-column spill output.",
      "href": "/en/docs/functions/distributions#fill"
    },
    {
      "lang": "en",
      "name": "FILL.RANDOM",
      "summary": "Builds a sequence like `FILL` and then shuffles it randomly.",
      "href": "/en/docs/functions/distributions#fillrandom"
    },
    {
      "lang": "en",
      "name": "AVERAGE.W",
      "summary": "Computes the weighted arithmetic mean.",
      "href": "/en/docs/functions/weighted-means#averagew"
    },
    {
      "lang": "en",
      "name": "HARMEAN.W",
      "summary": "Computes the weighted harmonic mean.",
      "href": "/en/docs/functions/weighted-means#harmeanw"
    },
    {
      "lang": "en",
      "name": "GEOMEAN.W",
      "summary": "Computes the weighted geometric mean.",
      "href": "/en/docs/functions/weighted-means#geomeanw"
    },
    {
      "lang": "en",
      "name": "VAR.P.W",
      "summary": "Computes the weighted population variance.",
      "href": "/en/docs/functions/weighted-variance#varpw"
    },
    {
      "lang": "en",
      "name": "VAR.S.W",
      "summary": "Computes the weighted sample variance.",
      "href": "/en/docs/functions/weighted-variance#varsw"
    },
    {
      "lang": "en",
      "name": "STDEV.P.W",
      "summary": "Computes the weighted population standard deviation.",
      "href": "/en/docs/functions/weighted-variance#stdevpw"
    },
    {
      "lang": "en",
      "name": "STDEV.S.W",
      "summary": "Computes the weighted sample standard deviation.",
      "href": "/en/docs/functions/weighted-variance#stdevsw"
    },
    {
      "lang": "en",
      "name": "VARCOEF",
      "summary": "Computes the population coefficient of variation.",
      "href": "/en/docs/functions/variation-coefficients#varcoef"
    },
    {
      "lang": "en",
      "name": "VARCOEF.S",
      "summary": "Computes the sample coefficient of variation.",
      "href": "/en/docs/functions/variation-coefficients#varcoefs"
    },
    {
      "lang": "en",
      "name": "VARCOEF.W",
      "summary": "Computes the weighted population coefficient of variation.",
      "href": "/en/docs/functions/variation-coefficients#varcoefw"
    },
    {
      "lang": "en",
      "name": "VARCOEF.S.W",
      "summary": "Computes the weighted sample coefficient of variation.",
      "href": "/en/docs/functions/variation-coefficients#varcoefsw"
    },
    {
      "lang": "en",
      "name": "PERCENTILE.INC.IFS",
      "summary": "Computes the inclusive percentile after applying filters.",
      "href": "/en/docs/functions/percentiles#percentileincifs"
    },
    {
      "lang": "en",
      "name": "PERCENTILE.EXC.IFS",
      "summary": "Computes the exclusive percentile after applying filters.",
      "href": "/en/docs/functions/percentiles#percentileexcifs"
    },
    {
      "lang": "en",
      "name": "PIVOT.COUNT",
      "summary": "Builds a pivot and counts non-empty values.",
      "href": "/en/docs/functions/pivot#pivotcount"
    },
    {
      "lang": "en",
      "name": "PIVOT.SUM",
      "summary": "Builds a pivot and computes sums.",
      "href": "/en/docs/functions/pivot#pivotsum"
    },
    {
      "lang": "en",
      "name": "PIVOT.AVERAGE",
      "summary": "Builds a pivot and computes arithmetic means.",
      "href": "/en/docs/functions/pivot#pivotaverage"
    },
    {
      "lang": "en",
      "name": "PIVOT.MIN",
      "summary": "Builds a pivot and computes minimums.",
      "href": "/en/docs/functions/pivot#pivotmin"
    },
    {
      "lang": "en",
      "name": "PIVOT.MAX",
      "summary": "Builds a pivot and computes maximums.",
      "href": "/en/docs/functions/pivot#pivotmax"
    },
    {
      "lang": "en",
      "name": "PIVOT.MEDIAN",
      "summary": "Builds a pivot and computes medians.",
      "href": "/en/docs/functions/pivot#pivotmedian"
    },
    {
      "lang": "en",
      "name": "PIVOT.PERCENTILE",
      "summary": "Builds a pivot and computes percentiles.",
      "href": "/en/docs/functions/pivot#pivotpercentile"
    },
    {
      "lang": "en",
      "name": "PIVOT.STDEV.S",
      "summary": "Builds a pivot and computes sample standard deviations.",
      "href": "/en/docs/functions/pivot#pivotstdevs"
    },
    {
      "lang": "en",
      "name": "PIVOT.STDEV.P",
      "summary": "Builds a pivot and computes population standard deviations.",
      "href": "/en/docs/functions/pivot#pivotstdevp"
    },
    {
      "lang": "en",
      "name": "PIVOT.VAR.S",
      "summary": "Builds a pivot and computes sample variances.",
      "href": "/en/docs/functions/pivot#pivotvars"
    },
    {
      "lang": "en",
      "name": "PIVOT.VAR.P",
      "summary": "Builds a pivot and computes population variances.",
      "href": "/en/docs/functions/pivot#pivotvarp"
    },
    {
      "lang": "en",
      "name": "PIVOT.VARCOEF.S",
      "summary": "Builds a pivot and computes sample coefficients of variation.",
      "href": "/en/docs/functions/pivot#pivotvarcoefs"
    },
    {
      "lang": "en",
      "name": "PIVOT.VARCOEF.P",
      "summary": "Builds a pivot and computes population coefficients of variation.",
      "href": "/en/docs/functions/pivot#pivotvarcoefp"
    },
    {
      "lang": "en",
      "name": "PIVOT.CONF.T",
      "summary": "Builds a pivot and computes t-based confidence interval half-widths.",
      "href": "/en/docs/functions/pivot#pivotconft"
    },
    {
      "lang": "en",
      "name": "PIVOT.CONF.NORM",
      "summary": "Builds a pivot and computes normal-approximation confidence interval half-widths.",
      "href": "/en/docs/functions/pivot#pivotconfnorm"
    },
    {
      "lang": "en",
      "name": "PIVOT.MAD",
      "summary": "Builds a pivot and computes median absolute deviations.",
      "href": "/en/docs/functions/pivot#pivotmad"
    },
    {
      "lang": "en",
      "name": "PIVOT.IQR",
      "summary": "Builds a pivot and computes interquartile ranges.",
      "href": "/en/docs/functions/pivot#pivotiqr"
    },
    {
      "lang": "en",
      "name": "NORM.DIST.RANGE",
      "summary": "Computes the probability of an interval under the normal distribution.",
      "href": "/en/docs/functions/distributions#normdistrange"
    },
    {
      "lang": "en",
      "name": "SHAPIRO.WILK",
      "summary": "Performs the Shapiro-Wilk normality test.",
      "href": "/en/docs/functions/normality#shapirowilk"
    },
    {
      "lang": "en",
      "name": "KOLMOGOROV.SMIRNOV",
      "summary": "Performs the Kolmogorov-Smirnov goodness-of-fit test for the selected distribution.",
      "href": "/en/docs/functions/normality#kolmogorovsmirnov"
    },
    {
      "lang": "en",
      "name": "T.TEST.1S",
      "summary": "Performs a one-sample t-test against a specified hypothetical mean.",
      "href": "/en/docs/functions/one-sample-tests#ttest1s"
    },
    {
      "lang": "en",
      "name": "PROP.TEST.1S",
      "summary": "Performs a one-sample proportion test.",
      "href": "/en/docs/functions/one-sample-tests#proptest1s"
    },
    {
      "lang": "en",
      "name": "WILCOXON.PAIRED",
      "summary": "Performs the Wilcoxon signed-rank test for dependent measurements.",
      "href": "/en/docs/functions/one-sample-tests#wilcoxonpaired"
    },
    {
      "lang": "en",
      "name": "WELCH.TEST.2S.G",
      "summary": "Performs Welch's two-sample t-test for two independent groups.",
      "href": "/en/docs/functions/two-sample-tests#welchtest2sg"
    },
    {
      "lang": "en",
      "name": "MANN.WHITNEY.G",
      "summary": "Performs the Mann-Whitney test for two independent groups.",
      "href": "/en/docs/functions/two-sample-tests#mannwhitneyg"
    },
    {
      "lang": "en",
      "name": "CHISQ.GOF",
      "summary": "Performs the chi-square goodness-of-fit test.",
      "href": "/en/docs/functions/goodness-of-fit#chisqgof"
    },
    {
      "lang": "en",
      "name": "ANOVA.G",
      "summary": "Performs one-way ANOVA on grouped data.",
      "href": "/en/docs/functions/anova#anovag"
    },
    {
      "lang": "en",
      "name": "ANOVA.RM",
      "summary": "Performs repeated-measures ANOVA across columns.",
      "href": "/en/docs/functions/anova#anovarm"
    },
    {
      "lang": "en",
      "name": "ANCOVA.G",
      "summary": "Performs ANCOVA with one factor and one or more covariates.",
      "href": "/en/docs/functions/ancova#ancovag"
    },
    {
      "lang": "en",
      "name": "CONTINGENCY.T",
      "summary": "Analyzes a contingency table entered directly as a frequency matrix.",
      "href": "/en/docs/functions/contingency#contingencyt"
    },
    {
      "lang": "en",
      "name": "CONTINGENCY.G",
      "summary": "Analyzes a contingency table built from grouped columns.",
      "href": "/en/docs/functions/contingency#contingencyg"
    },
    {
      "lang": "en",
      "name": "CORREL.SPEARMAN",
      "summary": "Computes Spearman correlation and its significance test.",
      "href": "/en/docs/functions/correlation#correlspearman"
    },
    {
      "lang": "en",
      "name": "CORREL.MATRIX",
      "summary": "Builds a correlation matrix including p-values and significance markers.",
      "href": "/en/docs/functions/correlation#correlmatrix"
    }
  ]
};
  ...
  "cs": [
    {
      ...
      "fileName": "Evalytics_CS_Setup.exe",
      "href": "/downloads/Evalytics_CS_Setup.exe",
      "exists": false
    }
  ],
  "en": [
    {
      ...
      "fileName": "Evalytics_EN_Setup.exe",
      "href": "/downloads/Evalytics_EN_Setup.exe",
      "exists": false
    }
  ]
};
