...
$manifest = $manifest.Replace("https://xlstat.evalytics.org/office/commands.html", "$BaseUrl/commands.html?v=$cacheKey")
$manifest = $manifest.Replace("https://xlstat.evalytics.org/office/taskpane.html", "$BaseUrl/taskpane.html?v=$cacheKey")
$manifest = $manifest.Replace("https://xlstat.evalytics.org/office/icon-16.png", "$BaseUrl/icon-16.png?v=$cacheKey")
$manifest = $manifest.Replace("https://xlstat.evalytics.org/office/icon-32.png", "$BaseUrl/icon-32.png?v=$cacheKey")
$manifest = $manifest.Replace("https://xlstat.evalytics.org/office/icon-80.png", "$BaseUrl/icon-80.png?v=$cacheKey")
